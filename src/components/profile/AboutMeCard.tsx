  ...
  return (
    <InfoCard className={`flex flex-col gap-4 p-8 ${className}`}>
      ...
      <p className="text-gray-extra-light">
        ...
        ReactJS, Next.js, TypeScript, and JavaScript. I&apos;ve led impactful
        projects and mentored teams at companies like Leland and Tintash.
        Currently, I&apos;m working at Gubbe, a Finnish startup revolutionizing
        elderly care by creating the best matchmaking platform for homes and
        nursing facilities in Finland and Sweden.
      </p>
      <p className="text-gray-extra-light">
